    ...
    item.addEventListener('click', function () {
      ...
      if (!isExpanded) {
        ...
        if (questionText && answerText) {
          questionText.textContent = stripFormattedContent(questionText.textContent);
          answerText.textContent = stripFormattedContent(answerText.textContent);
        }
      }
    });
  });
...
function stripFormattedContent(text) {
    if (!text) return '';
